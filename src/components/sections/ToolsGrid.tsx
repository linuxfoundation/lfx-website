...
const tools = [coreTool, ...supportingTools];
      ...
      <Container>
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-neutral-600">
            Everything open source projects need to manage, grow, and sustain their communities.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {tools.map((tool) => (
            <a
              ...
              className="group"
            >
              <Card hover className="h-full transition-colors group-hover:border-brand-200">
                <div className="mb-4 inline-flex rounded-lg bg-brand-50 p-3 text-brand-500">
                  <svg
                    className="h-6 w-6"
                    fill="none"
                    viewBox="0 0 24 24"
                ...
                <div className="mt-4 inline-flex items-center gap-1 text-sm font-medium text-brand-500">
                  Visit
